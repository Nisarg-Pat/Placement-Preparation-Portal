...
<td>
<center><a href="cancelreg2.php?eid=<?php echo $company->company_id;?>"><button class="lin" style=" border:1px solid black;padding: 10px;width: 100px;font-size: 20px;border-radius: 5px">Yes</button></a></center>
</td>
<td>
  <center>
  <a href="registered_company.php?eid=<?php echo $company->company_id;?>"><button class="lin" style=" border:1px solid black;padding: 10px;width: 100px; font-size: 20px;border-radius: 5px">No</button></a></center>
</td>
</table>
<br>
<br>
